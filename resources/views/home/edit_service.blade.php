                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 d-flex">
                            ...
                            <div class="col-sm-3 preview-image-video-container float-right mt-1">
                                <img id='edit_preview_photo_s' class="img-thumbnail user-img user-profile-img profilePicture"
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label for="sTitulo">Titulo:</label><span class="required">*</span>
                            <input type="text" name="sTitulo" id="sTitulo" class="form-control" required autofocus tabindex="1" value="">
                        </div>

                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label for="sTexto">Titulo:</label><span class="required">*</span>
                                <input type="text" name="sTexto" id="sTexto" class="form-control" required autofocus tabindex="1" value="">
                            </div>
...
@push('js')
    ...
    <script>
        $( document ).ready(function() {
            ...
            myModalService.addEventListener('hidden.bs.modal', function (event) {
                $("#sTitulo").val('')
                $("#sTexto").val('')
            })
            ...
            myModalService.addEventListener('show.bs.modal', function (event) {
                ...
                console.log("pensamiento id es :"+service)
                $('#IdService').val(service)
                $('#sTitulo').val(button.data('titulo'))
                $('#sTexto').val(button.data('texto'))
            })
            ...
            $(document).on('submit', '#editServiceForm', function (event) {
                ...
                formData.append('titulo', document.querySelector('#sTitle').value);
                formData.append('texto', document.querySelector('#sTexto').value);
