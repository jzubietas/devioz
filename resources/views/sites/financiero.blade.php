...
<div class="col-xl-12">
    ...
    <div class="card border-0">
        @can('editar-financiero-banner')
        <div class="panel panel-inverse">
            <div class="panel-heading ui-sortable-handle">
                <div class="panel-heading-btn">
                    <a class="btn btn-xs btn-icon btn-success" data-bs-toggle="modal" data-bs-target="#EditSiteBannerModal" data-bs-rubro="Financiero" data-rubro="Financiero"><i class="fa fa-pen"></i></a>
