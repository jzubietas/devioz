...
@section('content')
    ...
    <h1 class="page-header">Pensamientos  <small></small></h1>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table id="thoughts" class="table table-bordered thoughts">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Descripción</th>
...
@section('js')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            let table = new DataTable('#thoughts',
                {
                    dom:'<"row"<"col-sm-5"B><"col-sm-7"fr>>t<"row"<"col-sm-5"i><"col-sm-7"p>>',
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('thoughts.index') }}",
                    columns: [
