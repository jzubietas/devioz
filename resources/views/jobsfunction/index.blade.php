...
@section('content')
    ...
    <h1 class="page-header">Funciones  <small></small></h1>

    <div class="row">
        <div class="col-lg-12 ">
            <div class="float-md-start">
                <h2>Administracion de Funciones</h2>
            </div>
            <div class="float-md-end">
                <a class="btn btn-success" href="{{ route('jobsfunction.create') }}"> Nueva Funcion</a>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <table id="jobsfunction" class="table table-bordered users">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
