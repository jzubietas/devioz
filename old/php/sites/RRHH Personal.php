...
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs1.png" alt="" /></div><div class="menu-text">Alimentario</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs2.png" alt="" /></div><div class="menu-text">Comercio</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs3.png" alt="" /></div><div class="menu-text">Desarrollo Rural</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs4.png" alt="" /></div><div class="menu-text">Educación</div></a></div>
...
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs6.png" alt="" /></div><div class="menu-text">Entretenimiento</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs7.png" alt="" /></div><div class="menu-text">Financiero</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs8.png" alt="" /></div><div class="menu-text">Hotelería y Turismo</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs9.png" alt="" /></div><div class="menu-text">Legal y Asesoría</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs10.png" alt="" /></div><div class="menu-text">Logística</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs11.png" alt="" /></div><div class="menu-text">Medicina y Salud</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs12.png" alt="" /></div><div class="menu-text">Minería</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs13.png" alt="" /></div><div class="menu-text">Redes Sociales</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs14.png" alt="" /></div><div class="menu-text">RRHH / Personal</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs15.png" alt="" /></div><div class="menu-text">Refinería</div></a></div>
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs16.png" alt="" /></div><div class="menu-text">Seguridad</div></a></div>
...
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs18.png" alt="" /></div><div class="menu-text">Supermercados</div></a></div>
...
<div class="menu-item "><a href="#" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs20.png" alt="" /></div><div class="menu-text">Transporte</div></a></div>
