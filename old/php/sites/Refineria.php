...
<img class="card-img-top" src="../../assets/img/portada/Refineria.jpg" alt="" />
<div class="card-body">
...
<div class="card">
<img class="card-img-top" src="../../assets/img/gallery/Repsol.jpg" alt="Card image cap" />
<div class="card-body">
<h4 class="card-title">Repsol</h4>
<p class="card-text">Nuestra misión es contribuir a crear un futuro más sostenible, desarrollando proyectos focalizados en transición energética y sociedad.</p>
...
<div class="card">
<img class="card-img-top" src="../../assets/img/gallery/Petroperu.jpg" alt="Card image cap" />
<div class="card-body">
<h4 class="card-title">Petroperu</h4>
<p class="card-text">Proveer energía de calidad de forma competitiva, confiable y sostenible, contribuyendo al desarrollo y a la seguridad energética del país.</p>
<!--<p class="card-text text-gray">Last updated 3 mins ago</p>-->
</div>
</div>
...
<div class="card">
<img class="card-img-top" src="../../assets/img/gallery/Pecsa.jpg" alt="Card image cap" />
<div class="card-body">
<h4 class="card-title">Pecsa</h4>
<p class="card-text">Tenemos como objetivo principal cumplir en el sentido más amplio posible con nuestros clientes, con la sociedad y con el futuro de las generaciones venideras. </p>
<!--<p class="card-text text-gray">Last updated 3 mins ago</p>-->
</div>
</div>
...
<div class="card">
<img class="card-img-top" src="../../assets/img/gallery/Primax.jpg" alt="Card image cap" />
<div class="card-body">
<h4 class="card-title">Primax</h4>
<p class="card-text">Ser lideres en Latinoamérica por la calidad de nuestros productos y la excelencia de nuestros servicios, enfocándonos en la creación de valor para todos.</p>
<!--<p class="card-text text-gray">Last updated 3 mins ago</p>-->
</div>
</div>
