...
<div class="menu-item "><a href="sites/Alimentario.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs1.png" alt="" /></div><div class="menu-text">Alimentario</div></a></div>
<div class="menu-item "><a href="sites/Call Center.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-cc.png" alt="" /></div><div class="menu-text">Call Center</div></a></div>
<div class="menu-item "><a href="sites/Comercio.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs2.png" alt="" /></div><div class="menu-text">Comercio</div></a></div>
<div class="menu-item "><a href="sites/Consultoras.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-consultoras.png" alt="" /></div><div class="menu-text">Consultoras</div></a></div>
<div class="menu-item "><a href="sites/Desarrollo Rural.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs3.png" alt="" /></div><div class="menu-text">Desarrollo Rural</div></a></div>
<div class="menu-item "><a href="sites/Educación.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs4.png" alt="" /></div><div class="menu-text">Educación</div></a></div>
<!--<div class="menu-item "><a href="bootstrap_5.html" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs5.png" alt="" /></div><div class="menu-text">Energía</div></a></div> -->
<div class="menu-item "><a href="sites/Entretenimiento.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs6.png" alt="" /></div><div class="menu-text">Entretenimiento</div></a></div>
<div class="menu-item "><a href="sites/Financiero.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs7.png" alt="" /></div><div class="menu-text">Financiero</div></a></div>
<div class="menu-item "><a href="sites/Hoteleria y Turismo.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs8.png" alt="" /></div><div class="menu-text">Hotelería y Turismo</div></a></div>
<div class="menu-item "><a href="sites/Legal y Asesoría<.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs9.png" alt="" /></div><div class="menu-text">Legal y Asesoría</div></a></div>
<div class="menu-item "><a href="sites/Logística.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs10.png" alt="" /></div><div class="menu-text">Logística</div></a></div>
<div class="menu-item "><a href="sites/Medicina y Salud.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs11.png" alt="" /></div><div class="menu-text">Medicina y Salud</div></a></div>
<div class="menu-item "><a href="sites/Minería.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs12.png" alt="" /></div><div class="menu-text">Minería</div></a></div>
<div class="menu-item "><a href="sites/Redes Sociales.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs13.png" alt="" /></div><div class="menu-text">Redes Sociales</div></a></div>
<div class="menu-item "><a href="sites/RRHH Personal.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs14.png" alt="" /></div><div class="menu-text">RRHH / Personal</div></a></div>
<div class="menu-item "><a href="sites/Refineria.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs15.png" alt="" /></div><div class="menu-text">Refinería</div></a></div>
<div class="menu-item "><a href="sites/Seguridad.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs16.png" alt="" /></div><div class="menu-text">Seguridad</div></a></div>
<div class="menu-item "><a href="sites/Servicios Públicos.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs17.png" alt="" /></div><div class="menu-text">Servicios Públicos</div></a></div>
...
<div class="menu-item "><a href="sites/Supermercado.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs18.png" alt="" /></div><div class="menu-text">Supermercados</div></a></div>
<div class="menu-item "><a href="sites/Telecomunicaciones.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs19.png" alt="" /></div><div class="menu-text">Telecomunicaciones</div></a></div>
<div class="menu-item "><a href="sites/Transporte.php" class="menu-link"><div class="menu-icon-img"><img src="../assets/img/logo/logo-bs20.png" alt="" /></div><div class="menu-text">Transporte</div></a></div>
